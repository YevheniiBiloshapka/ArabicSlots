...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _components_header_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./components/header.js */ \"./src/js/components/header.js\");\n/* harmony import */ var _components_customSelect_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/customSelect.js */ \"./src/js/components/customSelect.js\");\n/* harmony import */ var _components_modal_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/modal.js */ \"./src/js/components/modal.js\");\n/* harmony import */ var _components_heroShowMore_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/heroShowMore.js */ \"./src/js/components/heroShowMore.js\");\n/* harmony import */ var _components_casinoCards_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/casinoCards.js */ \"./src/js/components/casinoCards.js\");\n/* harmony import */ var _components_toggleAccordion_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/toggleAccordion.js */ \"./src/js/components/toggleAccordion.js\");\n\n\n\n\n\n\n\nconst testSelect = () => {\n  // удалить\n  const testSelect = document.querySelector('[data-action=\"test-select\"]');\n  const iconSelect = document.querySelector('[data-action=\"icon-select\"]');\n  const smallTestSelect = document.querySelector('[data-action=\"test-select-small\"]');\n  const iconTestSelect = document.querySelector('[data-action=\"icon-select-small\"]');\n\n  if (testSelect) {\n    (0,_components_customSelect_js__WEBPACK_IMPORTED_MODULE_1__.customSelect)(testSelect, (selectedValue) => {\n      console.log('%ctypePaper:', 'color: coral; ', selectedValue);\n    });\n  }\n  if (iconSelect) {\n    (0,_components_customSelect_js__WEBPACK_IMPORTED_MODULE_1__.customSelect)(iconSelect, (selectedValue) => {\n      console.log('%ctypePaper:', 'color: coral; ', selectedValue);\n    });\n  }\n  if (smallTestSelect) {\n    (0,_components_customSelect_js__WEBPACK_IMPORTED_MODULE_1__.customSelect)(smallTestSelect, (selectedValue) => {\n      console.log('%ctypePaper:', 'color: coral; ', selectedValue);\n    });\n  }\n  if (iconTestSelect) {\n    (0,_components_customSelect_js__WEBPACK_IMPORTED_MODULE_1__.customSelect)(iconTestSelect, (selectedValue) => {\n      console.log('%ctypePaper:', 'color: coral; ', selectedValue);\n    });\n  }\n};\nconst showTableContent = () => {\n\n  const tableContentBox = document.querySelectorAll('[data-target-table-content]');\n  if (tableContentBox) {\n    tableContentBox.forEach(table => {\n        const btn = table.querySelector('[data-table-content-btn]');\n        btn.addEventListener('click', () => {\n          table.classList.toggle('show');\n        });\n      },\n    );\n  }\n};\nconst loadMoreBtn = () => {\n  const loadMoreBtns = document.querySelectorAll('[data-target-loading]');\n  if (loadMoreBtns) {\n    loadMoreBtns.forEach(btn => {\n      btn.addEventListener('click', () => {\n        btn.classList.add('loading');\n        btn.setAttribute('disabled', 'true');\n\n        setTimeout(() => {\n          btn.classList.remove('loading');\n          btn.removeAttribute('disabled');\n        }, 4000);\n      });\n    });\n  }\n};\n\ndocument.addEventListener('DOMContentLoaded', function() {\n\n\n  (0,_components_header_js__WEBPACK_IMPORTED_MODULE_0__.Header)();\n  (0,_components_modal_js__WEBPACK_IMPORTED_MODULE_2__[\"default\"])();\n  (0,_components_heroShowMore_js__WEBPACK_IMPORTED_MODULE_3__.heroShowMore)();\n  (0,_components_heroShowMore_js__WEBPACK_IMPORTED_MODULE_3__.handleHeroRating)();\n  (0,_components_casinoCards_js__WEBPACK_IMPORTED_MODULE_4__[\"default\"])();\n  loadMoreBtn();\n  showTableContent();\n  (0,_components_toggleAccordion_js__WEBPACK_IMPORTED_MODULE_5__.toggleAccordion)();\n\n});\n\n\n//# sourceURL=webpack://gulp-2022/./src/js/index.js?");
